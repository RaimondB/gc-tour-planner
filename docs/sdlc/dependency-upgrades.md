...
| 5   | **Frontend** — React 19 + maplibre-gl 5 + Vite (step 5→6→7→8) + Vitest 4                          | 🟡 ADR proposed — [ADR-0019](../adr/0019-frontend-majors-react-vite-maplibre.md); code PR next (adds map + Discover-clusters e2e)                                  |
