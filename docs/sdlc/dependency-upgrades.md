...
| 6   | **TypeScript 6**                                                                                  | ✅ merged (#25) — [ADR-0020](../adr/0020-typescript-6.md) (Accepted); currency-only (no advisory), typescript-only 5.6.3→6.0.3 across all 5 pins, **zero code changes** (strict config absorbed the lib.d.ts tightening), UAT redeployed. **Last cluster — upgrade programme complete.** |
