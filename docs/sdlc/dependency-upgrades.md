...
| 3   | **NestJS 11 + Express 5 + multer 2 + bullmq/@bull-board**                                         | ✅ implemented — [ADR-0017](../adr/0017-nestjs-11-express-5-migration.md) (Accepted); validated (audit clean, integration + upload-smoke green), PR pending merge |
| 4   | **zod 4 + nestjs-zod 5** — the shared wire contract                                               | ⬜ planned                                                                                                                                                        |
