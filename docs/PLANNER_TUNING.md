...
| `OSM2PGSQL_PROCESSES`            | `4`     | Parallel worker count. NUC is 4C/8T; default uses physical cores. Setting `8` uses hyperthreads for ~10-15% extra speed. No RAM cost worth worrying about. |
